...
void DefaultWatchface::draw_arrow(Framebuf* canvas, int16_t angle, uint8_t length, uint8_t size, uint16_t color) 
{
    angle -= 90;
...
void DefaultWatchface::draw_clock(Framebuf* canvas, uint8_t hour, uint8_t min, uint8_t sec) 
{
